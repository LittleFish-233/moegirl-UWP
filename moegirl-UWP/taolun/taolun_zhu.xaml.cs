...
namespace moegirl_UWP.taolun
{
    /// <summary>
    /// 可用于自身或导航至 Frame 内部的空白页。
    /// </summary>
    public sealed partial class taolun_zhu : Page
    {
        public taolun_zhu()
        {
        ...
        private async void Wangye_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                //导航到缓存地址
                if (daima.huancun.taolun.huancun_wangzhi == "")
                {
                    daima.huancun.taolun.huancun_wangzhi = daima.huancun.taolun_wangzhi;
                }
                webview1.Navigate(new Uri(daima.huancun.taolun.huancun_wangzhi));
            ...
            catch (Exception exc)
            {
                ...
                {
                    Title = "启动萌娘百科网页版失败",
                    Content = "无法导航到 " + daima.huancun.taolun.huancun_wangzhi + "，详细信息：" + exc.Message,
                    CloseButtonText = "好的"
                };
        ...
        {
            //记录当前链接
            daima.huancun.taolun.huancun_wangzhi = args.Uri.AbsoluteUri;
            //检查是否可以导航
        ...
        {
            webview1.Navigate(new Uri(daima.huancun.taolun_wangzhi));
        }
        ...
        private async void AppBarButton_Click_4(object sender, RoutedEventArgs e)
        {
            ...
            dp.SetText(daima.huancun.taolun.huancun_wangzhi);
