...
namespace moegirl_UWP.chuangzuo
{
    /// <summary>
    /// 可用于自身或导航至 Frame 内部的空白页。
    /// </summary>
    public sealed partial class chuangzuo_zhu : Page
    {
        public chuangzuo_zhu()
        {
        ...
        {
            //判断是否登入
            if(daima.huancun.zhanghao.shifou_dengru==false)
            {
                daima.huancun.chuangzuo.Kaishitishi("登入", 1);
            }
            try
            {
                //导航到缓存地址
                if (daima.huancun.chuangzuo.huancun_wangzhi == "")
                {
                    daima.huancun.chuangzuo.huancun_wangzhi = daima.huancun.jianshi_wangzhi;
                }
                webview1.Navigate(new Uri(daima.huancun.chuangzuo.huancun_wangzhi));
            ...
            catch (Exception exc)
            {
                ...
                {
                    Title = "启动萌娘百科网页版失败",
                    Content = "无法导航到 " + daima.huancun.chuangzuo.huancun_wangzhi + "，详细信息：" + exc.Message,
                    CloseButtonText = "好的"
                };
        ...
        {
            //记录当前链接
            daima.huancun.chuangzuo.huancun_wangzhi = args.Uri.AbsoluteUri;
            //检查是否可以导航
        ...
        private async void AppBarButton_Click_4(object sender, RoutedEventArgs e)
        {
            ...
            dp.SetText(daima.huancun.chuangzuo.huancun_wangzhi);
